...
CN_NAME = {
    ...
    "AD": "铸造铝合金", "AO": "氧化铝", "B": "豆二", "BB": "胶合板",
    "BC": "国际铜", "BR": "丁二烯橡胶", "CJ": "红枣", "CS": "玉米淀粉",
    "CY": "棉纱", "EB": "苯乙烯", "EC": "集运指数（欧线）", "FB": "纤维板",
    "JR": "粳稻", "LG": "原木", "LU": "低硫燃油", "NR": "20号胶",
    "PK": "花生", "PM": "普麦", "PX": "对二甲苯", "RI": "早籼稻",
    "RR": "粳米", "RS": "油菜籽", "RU": "天然橡胶", "SF": "硅铁",
    "SH": "烧碱", "SM": "锰硅", "SP": "纸浆", "SS": "不锈钢",
    "UR": "尿素", "WH": "强麦", "WR": "线材", "ZC": "动力煤",
}
